...
public class MoveTest {
	...
	public void setUp() throws Exception {
		this.first = new FirstMove(new Unit(Players.BLACK.player(), UnitType.QUEEN, 1));
		this.move = new Move(new Unit(Players.BLACK.player(), UnitType.ANT, 1), new Unit(Players.WHITE.player(), UnitType.QUEEN, 1), Orientation.LEFTMIDDLE);
	...
	public void testOtherUnit() throws Exception {
		...
		assertEquals(new Unit(Players.WHITE.player(), UnitType.QUEEN, 1), this.move.otherUnit());
	...
	public void testUnit() throws Exception {
		assertEquals(new Unit(Players.BLACK.player(), UnitType.QUEEN, 1), this.first.unit());
		assertEquals(new Unit(Players.BLACK.player(), UnitType.ANT, 1), this.move.unit());
